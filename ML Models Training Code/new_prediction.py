...
if __name__ == "__main__":
    ...
    # Specify the path to the audio file for prediction
    # Specify the path to the audio file for prediction
    audio_path = os.path.join(os.getcwd(), "testmusic", "stayinalivedisco.mp3")  # Update the path to your test music file
